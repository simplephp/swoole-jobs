...
class YiiAction extends BaseAction
{
    ...
    {
        $this->logger  = Logs::getLogger(Config::getConfig()['logPath'] ? Config::getConfig()['logPath'] : '', Config::getConfig()['logSaveFileApp'] ? Config::getConfig()['logSaveFileApp'] : '');
    }
    ...
    public function start(JobObject $JobObject)
    {
        ...
        $application         = new Application(Config::getConfig()['framework']['config'] ? Config::getConfig()['framework']['config'] : []);
