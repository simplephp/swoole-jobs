...
class Jobs
{
    ...
    public function __construct($pidInfoFile)
    {
        ...
        $this->sleep       = $this->config['sleep'] ? $this->config['sleep'] : $this->sleep;
        $this->maxPopNum   = $this->config['maxPopNum'] ? $this->config['maxPopNum'] : $this->maxPopNum;
    ...
    public function run($topic='')
    {
        if ($topic) {
            ...
            $this->queue->setTopics($this->config['job']['topics'] ? $this->config['job']['topics'] : []);
    ...
    {
        $classFramework=$this->config['framework']['class'] ? $this->config['framework']['class'] : '\Kcloze\Jobs\Action\SwooleJobsAction';
        try {
